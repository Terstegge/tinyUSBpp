...
public:
    ...
    virtual void port_reset(uint8_t delay_ms) = 0;
    ...
    // Parameter 0=disconnect, 1=connect low speed, 2=connect full speed
    function<void(uint8_t)> connect_handler;
    ...
    virtual bool control_xfer(uint8_t                           daddr,
                              ...
                              uint8_t                         * buffer,
                              std::function<void(hcd_xfer_result_t)> complete_cb) = 0;
